<?php
/**
 * Template Name: Juzt Single Raffle Template
 * Template Post Type: raffle
...
$template_content = $template_loader->get_json_template('single-raffle');

if (!$template_content) {
    // Fallback si no se encuentra el JSON
    echo '<div style="padding: 40px; text-align: center;">';
    echo '<h1>⚠️ Template JSON not found</h1>';
    echo '<p>Could not load: single-raffle.json</p>';
    echo '</div>';
    return;
}
