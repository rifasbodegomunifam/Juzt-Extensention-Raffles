      ...
      <table border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse; width: 500px;">
        ...
        <tr>
          <td style="padding: 0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%"
              style="text-align: center; font-size: 12px; text-transform: uppercase; font-weight: 600;">
              <tr>
          ...
          <td style="padding: 0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%"
              ...
              <tr>
                ...
                <td style="padding: 10px; border-bottom: 1px solid #000000; background: red; color: #fff;">Precio
                  Unitario</td>
                <td style="padding: 10px; border-bottom: 1px solid #000000; background: red; color: #fff;">Precio Total
                </td>
              </tr>
              <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td width="50%" valign="top" style="padding: 10px; text-align: left;">
                  <h3 style="margin: 0 0 10px 0; font-size: 12px; color: red; font-weight: 400;">COMPROBANTE DE PAGO
                  </h3>
                  <!--<p style="margin: 5px 0; font-size: 12px; color: #fff;font-weight: 600;">METODO</p>
                  <p style="margin: 0 0 15px 0; font-weight: bold; font-size: 18px; color: #FFF; font-weight: 400;">
                    BANCOLOMBIA</p>-->

                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="left" style="">
                        <p style="color: #FFF; font-size: 16px;">Hemos recibido la orden de tu compra para la rifa <a
                            style="color: #fff;" href="<?php echo $raffle["permalink"]; ?>" target="_blank"><?php echo $raffle["title"]; ?></a> en las proximas dos horas, recibiras
                          la validacion de tu pago y los numeros generados para tu participacion.</p>
